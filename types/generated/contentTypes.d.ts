...
export interface ApiPlayerPlayer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    position: Attribute.Enumeration<['delantero', 'portero']>;
    dominantFoot: Attribute.Enumeration<['izquierdo', 'derecho', 'diestro']>;
    birthDate: Attribute.Date;
    birthCountry: Attribute.String;
    birthCity: Attribute.String;
    youtubeVideo: Attribute.String;
    email: Attribute.Email;
    phone: Attribute.String;
    gallery: Attribute.Media<'images', true>;
    imagenPlayer: Attribute.Media<'images'>;
    slug: Attribute.UID<'api::player.player', 'firstName'>;
    imagenPlayerLink: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
